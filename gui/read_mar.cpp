...
ReadMar::ReadMar(std::string input_file)
{
	filename = input_file;
...
void ReadMar::print_header(std::string output_file)
{
	if (!list.empty())
	{
...
void ReadMar::unpack_word(BYTE *cimg, int x, int y, WORD *img)
{
...
void ReadMar::get_pck(int s, BYTE *cimg, WORD *img)
{
